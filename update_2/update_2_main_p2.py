...
import update_2_utils_p2 as u2u_p2 # for custom "update_2_utils" utility functions
...
target_df, targets = u2u_p2.encode_target(df, "SECU_FLAG") # encoding dataframe with "SECU_FLAG" as classification target
targets_dict = u2u_p2.col_count_perc(df, "SECU_FLAG", len(df.index), 2) # count unique targets and calculate percentiles
enc_df, repo_types = u2u_p2.encode_string_column(target_df, "REPO_TYPE") # encoding the "REPO_TYPE" column
repo_types_dict = u2u_p2.col_count_perc(df, "REPO_TYPE", len(df.index), 3) # count repo types and calculate percentiles
...
u2u_p2.classification(dtc, type_model_features, enc_df, fold_count, "Type", targets)

#-------------------- Size-Based Model -------------------#

u2u_p2.classification(dtc, size_model_features, enc_df, fold_count, "Size", targets)

#-------------------- Time-Based Model -------------------#

u2u_p2.classification(dtc, time_model_features, enc_df, fold_count, "Time", targets)

#----------------------- Full Model ----------------------#

u2u_p2.classification(dtc, full_model_features, enc_df, fold_count, "Full", targets)
...
u2u_p2.classification(rfc, type_model_features, enc_df, fold_count, "Type", targets)

#-------------------- Size-Based Model -------------------#

u2u_p2.classification(rfc, size_model_features, enc_df, fold_count, "Size", targets)

#-------------------- Time-Based Model -------------------#

u2u_p2.classification(rfc, time_model_features, enc_df, fold_count, "Time", targets)

#----------------------- Full Model ----------------------#

u2u_p2.classification(rfc, full_model_features, enc_df, fold_count, "Full", targets)
...
u2u_p2.classification(ann, type_model_features, enc_df, fold_count, "Type", targets)

#-------------------- Size-Based Model -------------------#

u2u_p2.classification(ann, size_model_features, enc_df, fold_count, "Size", targets)

#-------------------- Time-Based Model -------------------#

u2u_p2.classification(ann, time_model_features, enc_df, fold_count, "Time", targets)

#----------------------- Full Model ----------------------#

u2u_p2.classification(ann, full_model_features, enc_df, fold_count, "Full", targets)
...
u2u_p2.classification(knn, type_model_features, enc_df, fold_count, "Type", targets)

#-------------------- Size-Based Model -------------------#

u2u_p2.classification(knn, size_model_features, enc_df, fold_count, "Size", targets)

#-------------------- Time-Based Model -------------------#

u2u_p2.classification(knn, time_model_features, enc_df, fold_count, "Time", targets)

#----------------------- Full Model ----------------------#

u2u_p2.classification(knn, full_model_features, enc_df, fold_count, "Full", targets)
...
u2u_p2.classification(nbc, type_model_features, enc_df, fold_count, "Type", targets)

#-------------------- Size-Based Model -------------------#

u2u_p2.classification(nbc, size_model_features, enc_df, fold_count, "Size", targets)

#-------------------- Time-Based Model -------------------#

u2u_p2.classification(nbc, time_model_features, enc_df, fold_count, "Time", targets)

#----------------------- Full Model ----------------------#

u2u_p2.classification(nbc, full_model_features, enc_df, fold_count, "Full", targets)
